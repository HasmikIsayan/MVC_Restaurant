...
<body>
	<div class = "admin_all_menus">
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
				  ...
				  <li  class='active'><a href="admin_desserts">Desserts</a></li>
				</ul>
		...
		<div class = "admin_menu">
			<form   action = 'add_desserts' method = 'post' class = 'add_menu_form'  enctype="multipart/form-data">
		...
		<div class = 'admin_menu_items'>
			<?php foreach($this->desserts_items as $u){if($u){?>
			
			<div class = 'admin_menu_item'>
			
				<div class = 'admin_menu_item_image'><?php echo '<img width = "200"  src="data:image;base64,'.base64_encode($u["desserts_image"]).' ">' ?> </div>
				<div class = 'admin_texts'>
					<label>Desserts Name</label>
				</div>
				<div class = 'admin_menu_item_text'><?php echo $u['desserts_text']; ?> </div>
				<div class = 'admin_texts'>
					<label>Desserts Price</label>
				</div>
				<div class = 'admin_menu_item_text'><?php echo $u['desserts_price']; ?> </div>
				
				</br>
				<form action = "edit_desserts" method = 'post'>
...
$(document).ready(function(){
	$('.delete').click(function(e){
			...
			console.log(parent); 
		  $.ajax({
			   url: '/MVC_Restaurant/delete_desserts',
			   type: 'POST',
			   data: {
				   id:id
				   },
