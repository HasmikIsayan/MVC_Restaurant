...
<body>
	<div class = "admin_all_menus">
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
				  ...
				  <li class='active'><a href="admin_drinks">Drinks</a></li>
		...
		<div class = "admin_menu">
			<form   action = 'add_drinks' method = 'post' class = 'add_menu_form'  enctype="multipart/form-data">
				<input name="image" id="image"  type="file" required="required">
				<div class = 'admin_menu_text_root'><p>Drinks Name</p></div>
				<input class = 'admin_menu_text' type="text"  name="name" required="required" > <br />
				<div class = 'admin_menu_text_root'><p>Drinks Price</p></div>
		...
		<div class = 'admin_menu_items'>
			<?php foreach($this->drinks_items as $u){if($u){?>
			
			<div class = 'admin_menu_item'>
			
				<div class = 'admin_menu_item_image'><?php echo '<img width = "200"  src="data:image;base64,'.base64_encode($u["drinks_image"]).' ">' ?> </div>
				<div class = 'admin_texts'>
					<label>Drinks name</label>
				</div>
				<div class = 'admin_menu_item_text'><?php echo $u['drinks_name']; ?> </div>
				<div class = 'admin_texts'>
					<label>Drinks Price</label>
				</div>
				<div class = 'admin_menu_item_text'><?php echo $u['drinks_price']; ?> </div>
				
				</br>
				<form action = "edit_drinks" method = 'post'>
...
$(document).ready(function(){
	$('.delete').click(function(e){
			...
			console.log(parent); 
		  $.ajax({
			   url: '/MVC_Restaurant/delete_drinks',
			   type: 'POST',
			   data: {
				   id:id
				   },
