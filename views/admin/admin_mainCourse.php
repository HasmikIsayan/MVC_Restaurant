...
<body>
	<div class = "admin_all_menus">
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav">
				  ...
				  <li class='active'><a href="admin_mainCourse">Main Course</a></li>
		...
		<div class = "admin_menu">
			<form   action = 'add_mainCourse' method = 'post' class = 'add_menu_form'  enctype="multipart/form-data">
		...
		<div class = 'admin_menu_items'>
			<?php foreach($this->mainCourse_items as $u){if($u){?>
			
			<div class = 'admin_menu_item'>
			
				<div class = 'admin_menu_item_image'><?php echo '<img width = "200"  src="data:image;base64,'.base64_encode($u["mainCourse_image"]).' ">' ?> </div>
				<div class = 'admin_texts'>
					<label>Main Course Name</label>
				</div>
				<div class = 'admin_menu_item_text'><?php echo $u['mainCourse_name']; ?> </div>
				<div class = 'admin_texts'>
					<label>Main Course Price</label>
				</div>
				<div class = 'admin_menu_item_text'><?php echo $u['mainCourse_price']; ?> </div>
				
				</br>
				<form action = "edit_mainCourse" method = 'post'>
...
$(document).ready(function(){
	$('.delete').click(function(e){
			...
			console.log(parent); 
		  $.ajax({
			   url: '/MVC_Restaurant/delete_mainCourse',
			   type: 'POST',
			   data: {
				   id:id
				   },
